...
st.set_page_config(page_title="Transcript-Note-Taker")
logging.info("Streamlit app initialized.")
st.header("Transcript-Note-Taker")
st.write("Transcript-Note-Taker is an advanced application that effortlessly converts your YouTube videos into detailed notes using cutting-edge machine learning technology. Powered by Google Gemini and Python, it ensures accurate and efficient transcription for all your content needs.")
